...
export default function AdminProductList() {
  ...
  useEffect(() => {
    ...
    dispatch(
      fetchProductByFilterAsynce({ filter, sort, pagination, admin: true })
    );
                ...
                <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      of <span className="font-medium">{totalItems - 1}</span>{" "}
                      results
                    </p>
                  </div>
                  <div>
                    ...
                    >
                      <div
                        onClick={(e) => hanldePage(page > 1 ? page - 1 : page)}
                      ...
                      <div
                        onClick={(e) =>
                          hanldePage(page < totalPages ? page + 1 : page)
                        }
